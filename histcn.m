...
%     sub-intervals
%     If it's empty, a default of 100 subdivions will be used
% OUTPUT
...
for d=1:nd
    ...
    %%% HACK!!! For those points at the border:
    loc(loc(:,d) == DEFAULT_NBINS+1, d) = DEFAULT_NBINS;
end % for-loop

% Clean
clear dummy

% This is needed for the seldom points which hit at the right border
sz = max([sz; max(loc,[],1)]);
